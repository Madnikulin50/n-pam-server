(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { var g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.Terminal = f() } })(function () {
    ...
    exports.wcwidth = (function (opts) {
      ...
      function init_table () {
        ...
        for (var i = 0; i < CONTAINERSIZE; ++i) {
          ...
          while (pos--) { num = (num << 2) | wcwidthBMP(CODEPOINTS_PER_ITEM * i + pos) }
          table[i] = num
        }
        return table
      }
  ...
  }, {'./EventEmitter': 6, './SelectionModel': 12, './utils/Browser': 15, './utils/BufferLine': 16, './utils/Mouse': 21}],
